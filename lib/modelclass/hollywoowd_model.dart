// final hollywoodData = hollywoodDataFromJson(jsonString);

import 'dart:convert';

HollywoodData hollywoodDataFromJson(String str) => HollywoodData.fromJson(json.decode(str));

String hollywoodDataToJson(HollywoodData data) => json.encode(data.toJson());
...
class HollywoodData {
  ...
  HollywoodData.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    count = json['count'];
